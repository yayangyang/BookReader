...
public class PublishOptionPresenter extends RxPresenter<PublishOptionContract.View>
        implements PublishOptionContract.Presenter<PublishOptionContract.View>{

    private BookApi bookApi;

    @Inject
    public PublishOptionPresenter(BookApi bookApi) {
        this.bookApi = bookApi;
    }

    @Override
    public void publishBookReview(Map<String, String> params) {
        Disposable disposable = bookApi.publishBookReview(params).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                        new Consumer<MyBookReview>() {
                            @Override
                            public void accept(MyBookReview data) throws Exception {
                                LogUtils.e("accept"+data);
                                if(data!=null&&mView!=null){
                                    mView.publishBookReviewResult(data);
                                }
                            }
                        },
    ...
    @Override
    public void publishConversation(Map<String, String> params) {
        Disposable disposable = bookApi.publishConversation(params).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                        new Consumer<MyDiscussion>() {
                            ...
                            public void accept(MyDiscussion data) throws Exception {
                                LogUtils.e("accept"+data);
                                if(data!=null&&mView!=null){
                                    mView.publishConversationResult(data);
                                }
                            }
                        },
                        new Consumer<Throwable>() {
