...
public class BookHelpFragment extends BaseRVFragment<BookHelpPresenter,
        BookHelpList.HelpsBean,BaseViewHolder> implements BookHelpContract.View{
    ...
    public void configViews() {
        ...
        initAdapter(BookHelpAdapter.class,
...
//        mAdapter.setEnableLoadMore(true);
    ...
    @Override
    public void showBookHelpList(List<BookHelpList.HelpsBean> list, int start) {
        ...
        if(isRefresh){
            ...
            if(this.start>start){
                List<BookHelpList.HelpsBean> helpsBeans = mAdapter.getData().subList(0, start);
                helpsBeans.addAll(list);
                mAdapter.setNewData(helpsBeans);
            }else{
